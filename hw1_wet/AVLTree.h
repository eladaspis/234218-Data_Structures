...
public:
    ...
    Node* remove(T key, bool* change_root, Node* smallest){                                    //Node remove
        ...
        if(this->key < key){                          //search in right subtree
            ...
            if(this->right_node == nullptr || this->left_node == nullptr){            //only 1 child
                ...
                if(this->left_node == nullptr){             //no left node 
                    ...
                    if(this->parent != nullptr){            //check if "this" isnt the root
                        if(this->parent->left_node == this){                               
                            this->parent->left_node = this->left_node;
                         } 
                        else{
                            this->parent->right_node = this->left_node;
                        }    
...
//                this->value= nullptr;
        ...
        //at the end of the function first update the height of the current node and then 
        //check the balance factor and if needed do some gilgoolim
            //update heights and stuff
        }
...
//        cout <<  "key: " << *this->key << ", value: "<< *this->value << ", height: " << this->height << endl;
...
template <class T, class S>
void AVLTree<T,S>::remove(T key){                                            //avl tree remove
    if(this->root != nullptr){
        bool change_root = false;
